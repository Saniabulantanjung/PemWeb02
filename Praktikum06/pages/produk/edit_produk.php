  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nama" name="nama" value="<?= $result['nama'] ?>"
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="harga_beli" name="harga_beli" value="<?= $result['harga_beli'] ?>"
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="stok" name="stok" value="<?= $result['stok'] ?>" value=""
        type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="min_stok" name="min_stok" value="<?= $result['stok'] ?>"
        value=""
        type="text" class="form-control">
      </div>
    </div>
